                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="{{route("product.update",$product->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text"  value="{{$product->price}}" name="price" class="form-control" id="exampleInputEmail3" placeholder="price">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">sale</label>
                        @error('sale') <p style="color:red">{{$message}}</p> @enderror
                        <input type="text" value="{{$product->sale}}" name="sale" class="form-control" id="exampleInputPassword4" placeholder="sale">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">count</label>
                        @error('count') <p style="color:red">{{$message}}</p> @enderror
                        <input type="text" value="{{$product->count}}" name="count" class="form-control" id="exampleInputPassword4" placeholder="count">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="category" class="form-control" id="exampleSelectGender">
                         @foreach (config("cat.category") as $val)
                          <option @selected ($product->category==$val)  value="{{ $val }}">{{ $val }}</option>
