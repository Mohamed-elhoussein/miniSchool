...
<i class="lni lni-cart"></i>
 <span class="total-items total_item">2</span>
</a>

<div class="shopping-item">
<div class="dropdown-cart-header">
<span class="num_item">2 Items</span>
<a href="cart.html">View Cart</a>
</div>
<ul class="shopping-list">
  @foreach($itemCart as $cart)
<li>
<a href="javascript:void(0)" product_id="{{$cart->id}}" class="remove del_item" title="Remove this item">
  <i class="lni lni-close"></i>
</a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html">
  <img src="{{asset("storage/images/".$cart["products"][0]["images"][0]['img']) }}" alt="#"></a>
</div>
<div class="content">
<h4><a href="product-details.html">
Apple Watch Series 6</a></h4>
<p class="quantity">
  <span class="_count"> {{$cart->count}}</span>
  x - $
  <span class="amount _price">{{$cart["products"][0]["price"]}}</span>
</p>
</div>
</li>
@endforeach
