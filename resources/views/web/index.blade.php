...
<img src="{{ asset('storage/images/'.$val['images'][0]['img']) }}" alt="#">
<div class="button">
@if(Auth::check())
<bottom product_id="{{$val->id}}" class="btn addCart"><i class="lni lni-cart"></i> Add to Cart</bottom>
@else
<a href="{{ route('register') }}" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
@endif
</div>
</div>
...
<h4 class="title">
<a href="{{route('ProductDetails',$val->id)}}">{{$val->name}}</a>
</h4>
<ul class="review">
