...
<main id="gallery">
<div class="main-img">
<img src="{{asset('storage/images/'.$product['images'][0]['img'])}}" id="current" alt="#">
</div>
<div class="images">
    @foreach ($product->images as $file)
<img src="{{asset('storage/images/'.$file->img)}}" class="img" alt="#">
@endforeach
</div>
</main>
</div>
...
<a href="javascript:void(0)">{{$product->category}}</a></p>
<h3 class="price">${{$product->sale}}<span>${{$product->price}}</span></h3>
...
<img src="{{asset("web")}}/images/blog/comment1.jpg" alt="#">
...
<div class="single-review">
<img src="{{asset("web")}}/images/blog/comment2.jpg" alt="#">
<div class="review-info">
...
<div class="single-review">
<img src="{{asset("web")}}/images/blog/comment3.jpg" alt="#">
<div class="review-info">
