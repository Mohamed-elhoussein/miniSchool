...
<a class="cart-img" href="product-details.html"><img src="{{asset("web")}}/images/header/cart-items/item1.jpg" alt="#"></a>
</div>
<div class="content">
...
<a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html"><img src="{{asset("web")}}/images/header/cart-items/item2.jpg" alt="#"></a>
</div>
<div class="content">
...
<form class="row" method="post" action="{{ route('userCreate') }}">
  @csrf

<div class="col-sm-12">
<div class="form-group">
<label for="reg-ln"> Name</label>
<input name="name" class="form-control" type="text" id="reg-ln" required>
</div>
</div>
<div class="col-sm-12">
<div class="form-group">
